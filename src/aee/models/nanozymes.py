# src/aee/models/nanozymes.py
"""Nanozyme experiment data models and extraction logic."""

import logging
import re
from typing import Annotated, Any, List, Literal, Optional, Type, Union
...
# Task configuration for the nanozyme extraction pipeline
task_config = {
    "name": "nanozymes",
