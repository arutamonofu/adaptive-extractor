...
from aee.evaluation.matcher import ExperimentEntity, ExperimentMatcher
...
class TaskMetric:
    ...
    def __init__(self, task_config: Dict[str, Any]) -> None:
        ...
        self.threshold = settings.optimization.metric_threshold
    ...
    def __call__(self, example: dspy.Example, prediction: dspy.Prediction, trace: Any = None) -> float:
        ...
        try:
            ...
            if score < self.threshold:
                logger.debug(f"Score {score:.3f} below threshold {self.threshold}")
                return 0.0
