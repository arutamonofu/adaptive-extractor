...
from ae.extraction.pipeline import BatchPredictionRequest, BatchPredictionUseCase
...
def create_argument_parser() -> argparse.ArgumentParser:
    ...
    Returns:
        ArgumentParser configured with --config and --agent arguments.
    """
...
def extract_command(argv: Optional[list] = None) -> int:
    ...
    Example:
        ```python
        # Run extraction (defaults to root config/ directory)
