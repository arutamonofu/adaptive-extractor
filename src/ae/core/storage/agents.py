"""Agent repository and functional API for managing trained agents.

This module provides both functional APIs and a repository pattern for agent storage,
including version tracking, metadata management, and audit trails.
"""
...
class AgentRepository:
    """Repository pattern wrapper for managing trained agents with metadata.

    Delegates repository actions directly to core functional APIs to maintain backward compatibility.
    """
